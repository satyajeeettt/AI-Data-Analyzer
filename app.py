...
# =========================
# SIDEBAR (single block — was repeated twice before, which
# also caused a duplicate-widget-ID crash on the radio button)
# =========================
st.sidebar.markdown("""
# 🚀 DataPilot AI
...
# =========================
# HERO SECTION (single block — was repeated 3 times before)
# =========================
st.markdown("""
<div class="hero">
...
if file:
    ...
    if page == "Dashboard":
        ...
        if len(numeric_cols) > 1:
            ...
            heatmap = px.imshow(corr_matrix, text_auto=True, aspect="auto")
...
st.markdown("---")
st.markdown(
    "<div class='footer'>Built with ❤️ using Streamlit — DataPilot AI</div>",
    unsafe_allow_html=True
)